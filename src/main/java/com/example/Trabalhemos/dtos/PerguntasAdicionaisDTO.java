...
public record PerguntasAdicionaisDTO(Long id, VagaDTO vagaDTO, String pergunta) implements Serializable {
    @Serial
    ...
    public static PerguntasAdicionaisDTO toDTO(PerguntasAdicionais perguntasAdicionais) {
        ...
        return new PerguntasAdicionaisDTO(perguntasAdicionais.getId(), VagaDTO.toDTO(perguntasAdicionais.getVaga()),
    ...
    public static PerguntasAdicionais toEntity(PerguntasAdicionaisDTO perguntasAdicionaisDTO) {
        ...
        return new PerguntasAdicionais(VagaDTO.toEntity(perguntasAdicionaisDTO.vagaDTO()), perguntasAdicionaisDTO.pergunta());
    }
