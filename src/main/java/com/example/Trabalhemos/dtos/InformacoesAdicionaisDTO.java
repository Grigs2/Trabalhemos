...
public record InformacoesAdicionaisDTO(Long id, AplicacaoDTO aplicacaoDTO,
                                       PerguntasAdicionaisDTO pergunta, String Resposta) implements Serializable {
    @Serial
    ...
    public static InformacoesAdicionaisDTO toDTO(InformacoesAdicionais informacoesAdicionais) {
        ...
        return new InformacoesAdicionaisDTO(informacoesAdicionais.getId(), AplicacaoDTO.toDTO(informacoesAdicionais.getAplicacao()),
                PerguntasAdicionaisDTO.toDTO(informacoesAdicionais.getPergunta()), informacoesAdicionais.getResposta());
    }

    public static InformacoesAdicionais toEntity(InformacoesAdicionaisDTO dto) {
        if (dto == null) return null;
        return new InformacoesAdicionais(AplicacaoDTO.toEntity(dto.aplicacaoDTO()),
                PerguntasAdicionaisDTO.toEntity(dto.pergunta()), dto.Resposta());
    }
